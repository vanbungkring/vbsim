...
/**
 The base class for all SIM modules
 */
...
/**
 SIM Platform calls this method on startup.
 */
-(void)startup;

/**
 SIM Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 SIM Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 SIM Platform calls this method on resume.
 @param sender The sender of the event.
 */
