 ...
 * Copyright (c) 2009-2011 by SIM, Inc. All Rights Reserved.
...
//@interface SIMObject : NSObject
//@end

@interface SIMObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SIMObject class]])
		{
			for (NSString *key in [[(SIMObject*)o modules] allKeys])
			{
