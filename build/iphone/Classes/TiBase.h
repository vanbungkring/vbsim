...
// in simulator we redefine to format for SIM Developer console
...
{\
	NSString * exceptionName = [@"org.sim." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sim";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISIMNativeItemNone = -1, 
	UISIMNativeItemSpinner = -2,
	UISIMNativeItemProgressBar = -3,
	
	UISIMNativeItemSlider = -4,
	UISIMNativeItemSwitch = -5,
	UISIMNativeItemMultiButton = -6,
	UISIMNativeItemSegmented = -7,
	
	UISIMNativeItemTextView = -8,
	UISIMNativeItemTextField = -9,
	UISIMNativeItemSearchBar = -10,
	
	UISIMNativeItemPicker = -11,
	UISIMNativeItemDatePicker = -12,
	
	UISIMNativeItemInfoLight = -13,
	UISIMNativeItemInfoDark = -14,
	
	UISIMNativeItemDisclosure = -15,
	
	UISIMNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SIM instances of
